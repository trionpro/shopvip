...
if(isset($_POST['them_goi'])) {
	...
	mysqli_query($kun->connect_db(), "INSERT INTO `random_freefire` (`name`, `cname`, `thumb`, `giatien`, `mota`, `status`, `time`) VALUES ('".$_POST['name']."', '".$_POST['cname']."', '".$_POST['thumb']."', '".$_POST['giatien']."', '".$_POST['mota']."', 'false', '".time()."')");
...
<div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title">THÊM GÓI FREEFIRE RANDOM</h3>
...
<div class="card">
                            <div class="card-body">
                                <h4 class="card-title">DANH SÁCH GÓI RANDOM FREEFIRE</h4>
                            </div>
    ...
    <?php
        ...
        <tr>
           ...
           <td><?php echo mysqli_num_rows(mysqli_query($kun->connect_db(), "SELECT * FROM `random_freefire_nick` WHERE `cname`='".$row['cname']."' AND `status`='true'")) ;?></td>
           <td><?php echo mysqli_num_rows(mysqli_query($kun->connect_db(), "SELECT * FROM `random_freefire_nick` WHERE `cname`='".$row['cname']."' AND `status`='false'")) ;?></sup></td>
