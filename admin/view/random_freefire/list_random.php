...
$cname = $_GET['cname'];
 ...
 $sql1 = mysqli_query($kun->connect_db(), "SELECT * FROM `random_freefire_nick` WHERE `cname`='".$cname."' AND `status`='true' ORDER BY `time` DESC");

 $sql2 = mysqli_query($kun->connect_db(), "SELECT * FROM `random_freefire_nick` WHERE `cname`='".$cname."' AND `status`='false' ORDER BY `time` DESC");
