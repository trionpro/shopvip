...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/shopvip/admin/assets/images/favicon.png">
    <title>Admin Control</title>
    <!-- FONT -->
    <link href="https://fonts.googleapis.com/css2?family=Josefin+Sans&display=swap" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="/shopvip/admin/assets/assets/extra-libs/c3/c3.min.css" rel="stylesheet">
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="/shopvip/admin/assets/assets/libs/jquery/dist/jquery.min.js"></script>
    <script src="/shopvip/admin/assets/assets/libs/popper.js/dist/umd/popper.min.js"></script>
    <script src="/shopvip/admin/assets/assets/libs/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- apps -->
    <!-- apps -->
    <script src="/shopvip/admin/assets/dist/js/app-style-switcher.js"></script>
    <script src="/shopvip/admin/assets/dist/js/feather.min.js"></script>
    <script src="/shopvip/admin/assets/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="/shopvip/admin/assets/dist/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="/shopvip/admin/assets/dist/js/custom.min.js"></script>
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="/shopvip/admin"
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="/shopvip/admin/users"
