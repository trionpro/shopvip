...
if(!$_POST['giftcode']) {
    die("<script>swal('Lỗi', 'Bạn Chưa Nhập Mã GiftCode!', 'error');</script>");
}
...
echo 'Mã GiftCode: <b>'.$giftcode.'</b><br>Giá Trị: <b>'.$row['percent'].'%</b><br>Hạn Dùng: <b>'.date('H:i:s d/m/y' ,$row['expire']).'</b>';
?>