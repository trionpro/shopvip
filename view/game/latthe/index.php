...
<div class="row-flex-safari game-list">
  ...
  <div class="c-content-title-1 pd50" style="margin-top: 50px;">
    ...
    <center><b>
        <font color="red">Chú ý : <?php echo $kun->compact_number($ros['giatien']); ?>/1 lần lật hình </font>
      </b></center>
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
  <div class="list-roll" style="margin-top: 120px;">
    <div class="btn-top">
      ...
      <a href="/shopvip/user/rutkimcuong" class="btn btn-success m-btn m-btn--custom m-btn--icon m-btn--pill">
        <span>
          <i class="la la-cloud-upload"></i>
          <span>Rút quà</span>
        </span>
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"
              style="font-weight: bold;text-transform: uppercase;color: #FF0000;text-align: center">Thể Lệ</h4>
          </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"
              style="font-weight: bold;text-transform: uppercase;color: #FF0000;text-align: center">Uy Tín</h4>
          </div>
          <div class="modal-body" style="font-family: helvetica, arial, sans-serif;">
          </div>
          <div class="modal-footer">
...
<script type="text/javascript">
  ...
  function umbalaxibua(selector, card) {
    ...
    roll.src = "";
    roll.src = '/shopvip/assets/img/latthe/nen_latthe.png';

    $.ajax({
      type: 'post',
      dataType: "JSON",
      url: '/shopvip/system/latthe',
      data: {},
