...
<div class="c-layout-page">
    ...
    <div class="c-content-title-1 pd50">
        ...
        <center><b>
                <font color="red">Chú ý : <?php echo $kun->compact_number($ros['giatien']); ?>/1 lần </font>
            </b></center>
            ...
            <div class="contentquay contentquaysingle">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12">
                        ...
                        <?php if ($kun->is_mobile())
                            $cao = '215';
                        else
                            $cao = '400'; ?>
                        <div class="col-md-12 col-lg-12 col-xs-12"
                            style="background-color: #2b1919; height: <?php echo $cao; ?>px;margin-top: 50px;border-radius: 16px;border: 1px solid #ccc!important;">

                            <div style="margin-top: 30px;"></div>

                            <div class="col-lg-4 col-xs-4 col-md-4"><img id="role_1" style="width: 100%;"
                                    src="/shopvip/assets/img/bingo/bingo_minc.gif"></div>
                            <div class="col-lg-4 col-xs-4 col-md-4"><img id="role_2" style="width: 100%;"
                                    src="/shopvip/assets/img/bingo/bingo_minc.gif"></div>
                            <div class="col-lg-4 col-xs-4 col-md-4"><img id="role_3" style="width: 100%;"
                                    src="/shopvip/assets/img/bingo/bingo_minc.gif"></div>


                            <div class="col-lg-12 col-xs-12 col-md-12" style="margin-top: 30px;">
                                <center><button id="quay" class="btn btn-lg btn-success">Quay Bingo</button></center>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12 list-roll">
                        <div class="btn-top">
                            <a href="/shopvip/user/rutkimcuong"
                                class="uytin btn btn-success m-btn m-btn--custom m-btn--icon m-btn--pill">
                                Rút Quà
                            </a>
                            <a href="/shopvip/user/lichsugiaodich"
                                class="btn btn-success m-btn m-btn--custom m-btn--icon m-btn--pill">
                                Lịch Sử
                            </a>
                        </div>
    ...
    <?php
    for ($i = 1; $i <= 8; $i++) {
        echo '<img style="display: none;" src="/shopvip/assets/img/bingo/' . $i . '.gif">';
    }
    ?>
    ...
    <script type="text/javascript">
        ...
        function change_img(id, img_name) {
            ...
            roll.src = "";
            roll.src = '/shopvip/assets/img/bingo/' + img_name + '.gif';
        }
