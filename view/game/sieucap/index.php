...
<div class="c-layout-page">
    ...
    <div class="c-content-title-1 pd50">
        <h3 class="c-center c-font-uppercase c-font-bold">VÒNG QUAY GIẢI CỨU THẾ GIỚI
            <?php echo $kun->compact_number($ros['giatien']); ?></h3>
        <center><b>
                <font color="red">Chú ý : <?php echo $kun->compact_number($ros['giatien']); ?>/1 lần quay </font>
            </b></center>
                    ...
                    <table id="squaredesktop" class="square">
                        <tbody>
                            <tr>
                                <td></td>
                                <td>
                                    <div id="id21525" data-num="1" class="gift1 box"><img
                                            src="https://i.imgur.com/ySOYWJF.png"></div>
                                </td>
                                <td>
                                    <div id="id21526" data-num="2" class="gift2 box"><img
                                            src="https://i.imgur.com/yZkIl69.png"></div>
                                </td>
                                <td>
                                    <div id="id21527" data-num="3" class="gift3 box"><img
                                            src="https://i.imgur.com/0It0qP4.png"></div>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="id21538" data-num="12" class="gift12 box"><img
                                            src="https://i.imgur.com/Im2lcYW.pngg"></div>
                                </td>
                                <td colspan="3"></td>
                                <td>
                                    <div id="id21528" data-num="4" class="gift4 box"><img
                                            src="https://i.imgur.com/4O3PIwU.png"></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="id21537" data-num="11" class="gift11 box"><img
                                            src="https://i.imgur.com/WVOlIel.png"></div>
                                </td>
                                <td colspan="3">
                                    <div class="outer-btn">
                                        <div class="play"
                                            style="display: block; margin: 0 auto; width: 80%;position: relative;z-index: 1;">
                                            <img src="https://i.imgur.com/sos86SA.png" alt=""
                                                style="position: absolute;top: 0px;left: 17%;width:70%">
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div id="id21529" data-num="5" class="gift5 box"><img
                                            src="https://i.imgur.com/J1UzSga.png"></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="id21536" data-num="10" class="gift10 box"><img
                                            src="https://i.imgur.com/PkAmfDi.png"></div>
                                </td>
                                <td colspan="3"></td>
                                <td>
                                    <div id="id21530" data-num="6" class="gift6 box"><img
                                            src="https://i.imgur.com/oWfNt8V.png"></div>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>
                                    <div id="id21535" data-num="9" class="gift9 box"><img
                                            src="https://i.imgur.com/i59Ej71.png"></div>
                                </td>
                                <td>
                                    <div id="id21533" data-num="8" class="gift8 box"><img
                                            src="https://i.imgur.com/CWWxWLB.png"></div>
                                </td>
                                <td>
                                    <div id="id21531" data-num="7" class="gift7 box"><img
                                            src="https://i.imgur.com/EyDigM8.png"></div>
                                </td>
                                <td></td>
                            </tr>
                        </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="font-family: helvetica, arial, sans-serif;">
                    <p><strong>Vòng quay giải cứu thế giới của các nhân vật trong Game Free Fire trước đại dịch
                            CORONA</strong></p>
                    <p><strong>Mỗi lượt quay <?php echo $kun->compact_number($ros['giatien']); ?> có cơ hội nhận từ
                            100kc- 15000kc&nbsp;</strong></p>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"
                        style="font-weight: bold;text-transform: uppercase;color: #FF0000;text-align: center">Uy Tín
                    </h4>
                </div>
                <div class="modal-body" style="font-family: helvetica, arial, sans-serif;">
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"
                        style="font-weight: bold;text-transform: uppercase;color: #FF0000;text-align: center">Lượt chơi
                        gần đây</h4>
                </div>
                <div class="modal-body" style="font-family: helvetica, arial, sans-serif;">
    ...
    <div class="modal fade" id="noticeModal" role="dialog" aria-hidden="true" style="display: none;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body content-popup" style="font-family: helvetica, arial, sans-serif;">VÒNG QUAY SIÊU
                    CẤP <?php echo $kun->compact_number($ros['giatien']); ?></div>
                <div class="modal-footer">
                    <button type="button"
                        class="btn c-theme-btn c-btn-border-2x c-btn-square c-btn-bold c-btn-uppercase"
                        data-dismiss="modal">Đóng</button>
    ...
    $(document).ready(function (e) {
        ...
        $('.play').click(function () {
            if (roll_check) {
                ...
                roll_check = false;
                $.ajax({
                    url: '/shopvip/model/game/sieucap/xuly.php',
                    datatype: 'json',
                    data: {},
                    type: 'post',
