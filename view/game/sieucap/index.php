...
<h3 class="c-center c-font-uppercase c-font-bold">VÒNG QUAY GIẢI CỨU THẾ GIỚI <?php echo $kun->compact_number($ros['giatien']);?></h3>
...
<p><strong>Mỗi lượt quay <?php echo $kun->compact_number($ros['giatien']);?> có cơ hội nhận từ 100kc- 15000kc&nbsp;</strong></p>
</div>
...
<div class="modal-body content-popup" style="font-family: helvetica, arial, sans-serif;">VÒNG QUAY SIÊU CẤP <?php echo $kun->compact_number($ros['giatien']);?></div>
<div class="modal-footer">
<button type="button" class="btn c-theme-btn c-btn-border-2x c-btn-square c-btn-bold c-btn-uppercase" data-dismiss="modal">Đóng</button>
</div>
</div>
