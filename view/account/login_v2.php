...
<link rel="stylesheet" href="/shopvip/assets/Scripts/toastr/toastr.min.css"/>
<o id="result"></o>
...
<a href="#" style="color: #fcfcfc;margin-top: 10px;margin-bottom: 10px;display: block;font-style: italic;">Quên mật khẩu?</a><br>
</div>
...
<div class="social-auth-links text-center">
    ...
    <a href="/shopvip/login-fb.html" class="btn  btn-social btn-facebook btn-flat d-inline-block"><i class="fa fa-facebook"></i>Login FB</a>
    <a href="/shopvip/register.html" class="btn  btn-social btn-google btn-flat d-inline-block"><i class="icon-key icons"></i>Tạo tài khoản</a>
</div>
...
<script src="/shopvip/assets/Scripts/toastr/toastr.min.js"></script>
