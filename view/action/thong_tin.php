    ...
    <table class="table table-striped">
        <tbody>
            <tr>
                ...
                <th><span class="c-font-uppercase" data-toggle="tooltip" data-placement="top" title=""
                        data-original-title="Đây là ID tài khoản của bạn không phải mã giới thiệu"><?php echo $row['id']; ?></span>
                </th>
            </tr>
            <tr>
