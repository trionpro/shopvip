...
<div class="c-content-title-1">
		 	...
		 	<div class="row">
                ...
                <div class="col-md-12 col-lg-12 col-xs-12 hidden-lg hidden-md">
                    <img width="100%" height="200" src="<?php echo $_banner['url'];?>">
                </div> 
          ...
          <div class="box box-danger collapsed-box box-solid" style="padding: 0;"> 
           <div class="box-header with-border"> 
            <ul class="nav nav-tabs nav-justified"> 
             ...
             <li class=""><a data-toggle="tab" href="#topnap" aria-expanded="false"><h3 class="box-title">TOP THÁNG 05</h3></a></li> 
             <!--
...
$i++;
			 	...
			 	<div class="col-md-8 col-lg-8 col-xs-12 hidden-xs">
                    <img width="100%" height="445" src="<?php echo $_banner['url'];?>">
		 		</div>	 		
